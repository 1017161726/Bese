 ...
 *
 */
class BDialog(private val mCtx: Context) {
    ...
    private var isTitleBold = true

    @ColorInt
    private var cancelTextColor: Int = ContextCompat.getColor(mCtx, R.color.color_333)
    private var cancelTextBgColor: Int = ContextCompat.getColor(mCtx, R.color.color_0099ff)
    ...
    private var dialogLeftMargin: Int = getDp(80f)
    private var dialogRightMargin: Int = getDp(80f)
     ...
     * 设置Dialog的背景渲染色
     */
    fun setBackgroundColor(@ColorInt color: Int): BDialog {
     ...
     */
    fun setBackgroundColorRaw(@ColorInt color: Int): BDialog {
        this.backgroundColor = color
        return this
    }
     ...
     * 设置Dialog的背景渲染色
     */
    fun setBackgroundDim(dim: Float): BDialog {
     ...
     * 设置Dialog的标题
     */
    fun setTitle(title: String?): BDialog {
        this.title = title
        return this
    }
     ...
     * 设置Dialog的标题是否加粗
     */
    fun setTitleBold(isBold: Boolean = true): BDialog {
     ...
     * 设置Dialog的消息
     */
    fun setMessage(msg: String?): BDialog {
        this.message = msg
        return this
    }
     ...
     * 设置Dialog的取消按钮文案
     */
    fun setCancelText(cancelTxt: String?): BDialog {
     ...
     * 设置Dialog的取消按钮文字颜色
     */
    fun setCancelTextColor(@ColorInt color: Int): BDialog {
     ...
     * 设置Dialog的确认按钮文案
     */
    fun setEnterText(enterTxt: String?): BDialog {
     ...
     * 设置Dialog的确认按钮文字颜色
     */
    fun setEnterTextColor(@ColorInt color: Int): BDialog {
     ...
     * 设置Dialog的确认按钮文字颜色
     */
    fun setEnterTextBgColor(@ColorInt color: Int): BDialog {
     ...
     * 设置Dialog的监听
     */
    fun setListener(listener: DialogListener): BDialog {
     ...
     * 设置Dialog的左屏距
     */
    fun setLeftScreenMargin(margin750: Float): BDialog {
        this.dialogLeftMargin = getDp(margin750)
        return this
    }
     ...
     * 设置Dialog的右屏距
     */
    fun setRightScreenMargin(margin750: Float): BDialog {
        this.dialogRightMargin = getDp(margin750)
        return this
    }
     ...
     * 设置Dialog的根背景
     */
    fun setBackgroundDrawable(drawable: Drawable): BDialog {
     ...
     * 设置确定按钮单击后是否弹窗消失
     */
    fun setRightClickHideDialog(hide: Boolean): BDialog {
